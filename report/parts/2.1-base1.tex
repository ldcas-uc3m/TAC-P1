...
\subsubsection*{Peor caso}
En este algoritmo, el peor caso será aquel en el que el primer número, esto es a al izquierda del \$, tenga un mayor numero de digitos. Esto se debe a que para cada digito a la izquierda del \$, este deberá copiarse a la sgunda cinta  para posteriormente escribirse de nuevo en la primera.
