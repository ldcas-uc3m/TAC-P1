...
Realizamos la evaluación empírica en el peor caso, tomando como $n$ el tamaño de la cadena de entrada, compuesta por por 1 a la derecha del \$ ya que se trataría del peor caso, y midiendo el número de pasos realizados para resolver el problema\footnote{Los datos se pueden encontrar en \texttt{data/MT-1A.csv}.}:
...
Resolviendo, $a=16$, $b=1-55$ y $c=63$, por lo que:

\begin{equation}
    T_{\mathrm{1A}}(n) = 16n^2-55n + 63
\end{equation}
...
\begin{equation}
    T_{\mathrm{1A}}(n) = \frac{1113}{100} n^2
\end{equation}
